...
class RedisSinkConnectorConfig extends RedisConnectorConfig {
  ...
  public static final String EXPIRE_SECS_DOC = "seconds until key expires";
  public static final String EXPIRE_CONF = "redis.key.expire.secs";
  ...
  public static ConfigDef config() {
    return RedisConnectorConfig.config()
        .define(
            ...
            ConfigKeyBuilder.of(EXPIRE_CONF, ConfigDef.Type.LONG)
                .documentation(EXPIRE_SECS_DOC)
                .defaultValue(-1L)
                .importance(ConfigDef.Importance.MEDIUM)
                .build()
        );
